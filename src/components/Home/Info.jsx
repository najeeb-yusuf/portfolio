    ...
    return (
        <>
            ...
            <div className="pt-3 mt-3 ">
                <p className="text-yellow-500 font-secondary text-center text-5xl my-3">Najeeb Yusuf</p>
                <div className="flex h-16 font-tertiary pl-10 justify-between items-center text-xl">
                    ...
                    <ul className=" text-yellow-500 list-none ml-3 overflow-hidden leading-8 h-8">
